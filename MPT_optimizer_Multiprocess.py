...
if __name__ == "__main__":
    ...
    for i in range(0,11):
        ...
        startTrainingData = start.strftime("%d/%m/%Y")
        endTrainingData = end.strftime("%d/%m/%Y")
        ...
        if prevOptPortTickers != None :
            ...
            print("Max Sharpe Ratio: {} for Portofolio {} with respectively weights {}".format(prevSharpe, prevOptPortTickers,prevOptPortFinalWeights))
